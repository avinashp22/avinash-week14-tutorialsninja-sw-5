...
public class MyAccountsTest extends BaseTest {
    ...
    public void verifyThatUserRegisterAccountSuccessfully(){
        ...
        registerPage.enterFirstName("AAAvviinnashh");
        //3.4 Enter Last Name
        registerPage.enterLastName("PPaatell");
        //3.5 Enter Email
        String name = UUID.randomUUID().toString();
        email = name + "@gmail.com";
        registerPage.enterEmail(email);
        //3.6 Enter Telephone
        registerPage.enterPhoneNumber("07759426509");
        //3.7 Enter Password
    ...
    public void verifyThatUserShouldLoginAndLogoutSuccessfully(){
        ...
        loginPage.enterEmailId("avinashp22@gmail.com");
        //4.5 Enter Password
